...
void setup() {
  ...
  double lat1 = 12.9702572; // Latitude of Vellore
  double lon1 = 79.1563892; // Longitude of Vellore
  double lat2 = 12.9692081; // Latitude of Chennai
  double lon2 = 79.1635074; // Longitude of Chennai
  ...
  Serial.print(act_bearing, 4); //50
  Serial.print("prev_bearing:");
  Serial.print(prev_bearing,4); //100 
  Serial.print("°");
